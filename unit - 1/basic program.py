...
# 19.Take two strings as input from the user and concatenate them.
...
# 20.Take a number and a string from the user and repeat the string for that many times.
text = input("enter a string:")
num = int(input("eneter number of times:"))
result = num * text
print("result:",result)

# 21.Take an input character from the user and check whether that character is present in the above given string or not. – Using ‘in’ operator and using ‘not in’ operator
text = "Pythom Programming"
ch = input("Enter a character:")
if ch in text:
    print("Character is present")
else:
    print("Charater is not present")

if ch not in text:
    print("Character is not present")
else:
    print("Charater is present")
