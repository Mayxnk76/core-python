...
# Q14 Create a list of 10 numbers and put all the odd
# numbers in 1 list and even numbers in another list.
...
# Q15) Write a program to create a list of words. Print all the
# palindrome words from it.

name = ["nayan", "mina", "manish", "arjun", "nitin", "naman"]
